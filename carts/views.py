...
def _cart_id(request): #_cart => _ implements private function
...
def add_cart(request, product_id):
    ...
    try:
        cart = Cart.objects.get(cart_id=_cart_id(request)) #To get the cart using cart_id present in the session
